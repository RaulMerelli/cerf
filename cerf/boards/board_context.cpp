...
constexpr BoardIdEntry kBoardIds[] = {
    ...
    {"hmi_ktp400_mobile", Board::HmiKtp400Mobile},
    {"hmi_ktp400_mobile_v13", Board::HmiKtp400Mobile},
...
const char* BoardContext::BoardName(Board b) {
    switch (b) {
        ...
        case Board::HmiKtp400Mobile:  return "Siemens SIMATIC HMI KTP400 Mobile";
...
const char* BoardContext::ShortBoardName(Board b) {
    switch (b) {
        ...
        case Board::HmiKtp400Mobile:  return "KTP400 Mobile";
