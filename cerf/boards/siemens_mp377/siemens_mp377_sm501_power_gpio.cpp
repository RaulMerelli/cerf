...
void SiemensMp377Sm501PowerGpio::Initialize(
    SiemensMp377Sm501Regs& registers) {
...
void SiemensMp377Sm501PowerGpio::WritePowerModeControl(uint32_t value) {
    ...
    emu_.Get<SiemensMp377Sm501Regs>()
        .regs_[kSm501PowerModeControlReg / 4u] = value;
}
...
bool SiemensMp377Sm501PowerGpio::IsAc97LinkMuxed() const {
    return (ActiveAc97GpioMuxMask() & kSm501GpioAc97Mask) ==
           kSm501GpioAc97Mask;
}
...
bool SiemensMp377Sm501PowerGpio::IsCodecResetDeasserted() const {
    ...
    if ((direction & kMp377CodecResetGpioBit) != 0u &&
        (data & kMp377CodecResetGpioBit) != 0u) return true;
