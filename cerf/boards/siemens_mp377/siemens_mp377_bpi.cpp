...
private:
    ...
    static constexpr uint32_t kMramAliasOff =
        siemens_mp377::kMp377MramAliasPa - 0xF0000000u;
    ...
    void BuildHwi() {
        ...
        /* P377 nk.exe sub_80446218 HWI_Init handoff layout. */
        hwi_.fill(0);
        hwi_[0x00] = 0xA5u;
        hwi_[0x7F] = 0x5Au;
        hwi_[0x0E] = 0x20u;
        ...
        /* P377 nk.exe sub_80446F50 HWI framebuffer defaults. */
        hwi_[0x14] = 0xFFu;
        hwi_[0x15] = 0xFFu;
        hwi_[0x16] = 0xFFu;
        hwi_[0x17] = 0xFFu;
        ...
        /* P377 nk.exe sub_804462FC MAC handoff layout. */
        mac_.fill(0);
        mac_[0x00] = 0x55u;
        mac_[0x01] = 0xAAu;
        mac_[0x08] = 0x02u;
