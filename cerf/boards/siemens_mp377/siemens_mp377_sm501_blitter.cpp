...
uint32_t SiemensMp377Sm501Blitter::R(uint32_t off) const {
    return registers_->ReadSm501Register(off);
}
uint32_t SiemensMp377Sm501Blitter::SrcPitchField(uint32_t v) { return v & k2dPitchMask; }
uint32_t SiemensMp377Sm501Blitter::DstPitchField(uint32_t v) { return (v >> 16) & k2dPitchMask; }
uint32_t SiemensMp377Sm501Blitter::Lo16(uint32_t v) { return v & 0xFFFFu; }
uint32_t SiemensMp377Sm501Blitter::Hi16(uint32_t v) { return (v >> 16) & 0xFFFFu; }
...
SiemensMp377Sm501Blitter::VramBlitRect SiemensMp377Sm501Blitter::NormalizeVramBlitRect(const SiemensMp377Sm501Blitter::State2d& st) const {
...
void SiemensMp377Sm501Blitter::ExecuteDdiVideoToVideoChunk(const SiemensMp377Sm501Blitter::State2d& st, const SiemensMp377Sm501Blitter::VramBlitRect& r,
