...
public:
    ...
    /* Hibernation: the owning controller forwards these (the codec pattern in
       agent_docs/hibernation.md — a device Service is not in the peripheral
       walk, so its state rides on the controller's section). */
