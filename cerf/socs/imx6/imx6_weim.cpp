...
/* WEIM/EIM chip-select timing registers. The reset stub programs the
   CS0..CS3 GCR/RCR/WCR groups and global control registers before any
   external-bus access occurs. */
