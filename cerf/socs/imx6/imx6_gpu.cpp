...
class Imx6Gpu3d : public Peripheral {
public:
    ...
    void OnShutdown() override {
        ...
        { std::lock_guard<std::mutex> g(fe_cv_mtx_); fe_cv_.notify_all(); }
        if (fe_worker_.joinable()) fe_worker_.join();
    }

    uint32_t MmioBase() const override { return 0x00130000u; }
    uint32_t MmioSize() const override { return 0x4000u; }

    virtual VivanteCore Core() const { return VivanteCore::Gc8803d; }
    bool Is2d() const { return Core() == VivanteCore::Gc3202d; }
    virtual int IrqSpi() const { return 9; }  /* i.MX6 GPU3D: GIC SPI 9 */
    ...
    uint32_t ReadWord(uint32_t addr) override {
        ...
        if (off == 0x000u || off == 0x004u || off == 0x010u ||
            off == 0x664u || off == 0x668u || off == 0x66Cu) {
        ...
        case 0x008:  /* VIVS_HI_AXI_CONFIG */
            value = st_.regs_[off >> 2];
            break;
        case 0x00c:  /* VIVS_HI_AXI_STATUS */
            value = 0u;
            break;
        ...
        case 0x014:  /* VIVS_HI_INTR_ENBL */
            value = st_.intr_enable_;
            break;
        case 0x108:  /* VIVS_PM_MODULE_STATUS */
            value = 0u;
            break;
        case 0x188:  /* VIVS_MMUv2_STATUS */
            value = st_.regs_[off >> 2];
            break;
        case 0x190:  /* VIVS_MMUv2_EXCEPTION_ADDR[0] */
        case 0x194:  /* VIVS_MMUv2_EXCEPTION_ADDR[1] */
        case 0x198:  /* VIVS_MMUv2_EXCEPTION_ADDR[2] */
        case 0x19c:  /* VIVS_MMUv2_EXCEPTION_ADDR[3] */
            value = st_.regs_[off >> 2];
            break;
        case 0x384:  /* VIVS_MMUv2_SEC_STATUS */
            value = 0u;
            break;
        case 0x180:  /* VIVS_MMUv2_SAFE_ADDRESS */
            value = st_.regs_[off >> 2];
            break;
        case 0x18c:  /* VIVS_MMUv2_CONTROL */
            value = st_.regs_[off >> 2] & 1u;
            break;
        case 0x018:  /* VIVS_HI_CHIP_IDENTITY (obsolete on these cores) */
            value = identity.chip_identity;
            break;
        case 0x01c:  /* VIVS_HI_CHIP_FEATURE */
            value = identity.features;
            break;
        case 0x020:  /* VIVS_HI_CHIP_MODEL */
            value = identity.model;
            break;
        case 0x024:  /* VIVS_HI_CHIP_REV */
            value = identity.revision;
            break;
        case 0x028:  /* VIVS_HI_CHIP_DATE */
            value = identity.date;
            break;
        case 0x02c:  /* VIVS_HI_CHIP_TIME */
            value = identity.time;
            break;
        case 0x030:  /* VIVS_HI_CHIP_CUSTOMER_ID */
            value = 0u;
            break;
        case 0x034:  /* VIVS_HI_CHIP_MINOR_FEATURE_0 */
            value = identity.minor[0];
            break;
        case 0x038:  /* VIVS_HI_CACHE_CONTROL */
        case 0x03c:  /* VIVS_HI_MEMORY_COUNTER_RESET */
            value = st_.regs_[off >> 2];
            break;
        case 0x040:  /* VIVS_HI_PROFILE_READ_BYTES8 */
        case 0x044:  /* VIVS_HI_PROFILE_WRITE_BYTES8 */
            value = 0u;
            break;
        case 0x048:  /* VIVS_HI_CHIP_SPECS */
            value = identity.specs[0];
            break;
        case 0x074:  /* VIVS_HI_CHIP_MINOR_FEATURE_1 */
            value = identity.minor[1];
            break;
        case 0x080:  /* VIVS_HI_CHIP_SPECS_2 */
            value = identity.specs[1];
            break;
        case 0x084:  /* VIVS_HI_CHIP_MINOR_FEATURE_2 */
            value = identity.minor[2];
            break;
        case 0x088:  /* VIVS_HI_CHIP_MINOR_FEATURE_3 */
            value = identity.minor[3];
            break;
        case 0x08c:  /* VIVS_HI_CHIP_SPECS_3 */
            value = identity.specs[2];
            break;
        case 0x094:  /* VIVS_HI_CHIP_MINOR_FEATURE_4 */
            value = identity.minor[4];
            break;
        case 0x09c:  /* VIVS_HI_CHIP_SPECS_4 */
            value = identity.specs[3];
            break;
        case 0x0a0:  /* VIVS_HI_CHIP_MINOR_FEATURE_5 */
            value = identity.minor[5];
            break;
        case 0x0a8:  /* VIVS_HI_CHIP_PRODUCT_ID */
        case 0x0e8:  /* VIVS_HI_CHIP_ECO_ID */
            value = 0u;
            break;
        case 0x104:  /* VIVS_PM_MODULE_CONTROLS */
            value = st_.regs_[off >> 2] | 0x004304FFu;
            break;
        case 0x10c:  /* VIVS_PM_PULSE_EATER */
            value = st_.regs_[off >> 2] ? st_.regs_[off >> 2] : 0x01590880u;
            break;
        ...
        case 0x480:  /* VIVS_HI_BUS_CONFIG */
            value = st_.regs_[off >> 2];
            break;
        case 0x430:  /* VIVS_HI_MEMORY_FLUSH: self-clearing pulse */
            value = 0u;
            break;
        ...
        case 0x46c:  /* VIVS_HI_PROFILE_HI_READ */
            value = 0u;
            break;
    ...
    void WriteWord(uint32_t addr, uint32_t value) override {
        ...
        case 0x000:  /* soft-reset bit self-clears; idle bits remain read-only high */
            if ((value & 0x00001000u) != 0u)
                mem_->ResetMmuv2State();
        ...
        case 0x03c:  /* VIVS_HI_MEMORY_COUNTER_RESET */
            st_.regs_[off >> 2] = value;
            break;
        case 0x184:  /* VIVS_MMUv2_CONFIGURATION, rnndb masked register */
            mem_->WriteMmuv2Configuration(value);
            break;
        case 0x180:  /* VIVS_MMUv2_SAFE_ADDRESS: write-once after reset */
            mem_->WriteMmuv2SafeAddress(value);
            break;
        case 0x104:  /* VIVS_PM_MODULE_CONTROLS */
        case 0x10c:  /* VIVS_PM_PULSE_EATER */
        case 0x400:  /* VIVS_HI_MMU_FE_PAGE_TABLE */
        ...
        case 0x188:  /* VIVS_MMUv2_STATUS: acknowledge all fault slots */
            ...
            mem_->UpdateIrq();
            break;
        case 0x384:  /* secure MMU is not exposed on the i.MX6 profiles */
            st_.regs_[off >> 2] = 0u;
            break;
        default:
            if (mem_->IsGpuStateOffset(off)) {
                ...
                if (off == 0x01294u && (value & (1u << 3)) == 0u)
                    blit_->ExecuteVideoRasterizer(value & 3u);
                if (off == 0x01600u && value != 0u)
                    blit_->ExecuteRs();
                if (off == 0x016B0u && value != 0u)
                    blit_->ExecuteRsInPlace(value);
                break;
            }
    ...
    void SaveState(StateWriter& w) override {
        ...
        uint32_t b = st_.irq_asserted_ ? 1u : 0u; w.Write(b);
        b = st_.fe_live_ ? 1u : 0u; w.Write(b);
        b = st_.fe_idle_ring_ ? 1u : 0u; w.Write(b);
        w.Write(st_.fe_ring_pc_);
        w.Write(st_.fe_ring_prefetch_);
        w.Write(st_.fe_window_words_);
        w.Write(st_.fe_resume_idle_target_);
        uint32_t address_space =
            static_cast<uint32_t>(st_.fe_address_space_);
    ...
    void RestoreState(StateReader& r) override {
        ...
        uint32_t b = 0;
        r.Read(b); st_.irq_asserted_ = b != 0u;
        r.Read(b); st_.fe_live_ = b != 0u;
        r.Read(b); st_.fe_idle_ring_ = b != 0u;
        ...
        st_.fe_address_space_ = address_space <=
            static_cast<uint32_t>(FeCommandAddressSpace::Virtual)
            ? static_cast<FeCommandAddressSpace>(address_space)
            : FeCommandAddressSpace::Physical;
        r.Read(address_space);
        st_.fe_resume_address_space_ = address_space <=
            static_cast<uint32_t>(FeCommandAddressSpace::Virtual)
            ? static_cast<FeCommandAddressSpace>(address_space)
            : FeCommandAddressSpace::Physical;
        r.Read(st_.fe_call_depth_);
        if (st_.fe_call_depth_ > kFeCallStackDepth)
            st_.fe_call_depth_ = 0u;
    ...
    void FeLoop() {
        ...
        while (!fe_stop_.load(std::memory_order_acquire)) {
            ...
            fe_cv_.wait_for(g, kInterval, [this] {
                return fe_stop_.load(std::memory_order_acquire);
            });
        }
    }
...
private:
    bool FrontendBusy() const {
        return st_.fe_live_ && !st_.fe_idle_ring_;
    }
...
class Imx6Gpu2d : public Imx6Gpu3d {
public:
    using Imx6Gpu3d::Imx6Gpu3d;
    uint32_t MmioBase() const override { return 0x00134000u; }
    VivanteCore Core() const override { return VivanteCore::Gc3202d; }
    int IrqSpi() const override { return 10; }
};

class Imx6GpuVg : public Imx6Gpu3d {
public:
    using Imx6Gpu3d::Imx6Gpu3d;
    uint32_t MmioBase() const override { return 0x02204000u; }
    VivanteCore Core() const override { return VivanteCore::Gc355Vg; }
    int IrqSpi() const override { return 11; }
};
