...
/* Per-SoC bootloader-handoff state: DRAM region(s), the initial SP
   the kernel inherits, and the SoC's static cached-DRAM VA→PA map.
   The CE kernel itself walks its own OEMAddressTable and builds the
   real page tables once it gains control. */
