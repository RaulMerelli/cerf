...
private:
    ...
    static constexpr uint32_t kOffPriomask  = 0x008;  /* PRIOMASK R/W */
    static constexpr uint32_t kOffSyncctrl  = 0x00C;  /* SYNCCTRL R/W */
    static constexpr uint32_t kOffDsmint    = 0x010;  /* DSMINT   R/W */
