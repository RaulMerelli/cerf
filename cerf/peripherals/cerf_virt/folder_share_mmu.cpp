...
REGISTER_SERVICE(FolderShareMmu);

bool FolderShareMmu::ReadBlob(uint32_t va, void* dst, uint32_t n) {
...
bool FolderShareMmu::WriteBlob(uint32_t va, const void* src, uint32_t n) {
    ArmMmu& mmu = emu_.Get<ArmMmu>();
