...
/* RTC8571.dll set_time @0xEF2E2830 / get_time @0xEF2E2B58: regs 0..6 =
...
public:
    ...
    bool ShouldRegister() override {
        ...
        return board && board->GetBoard() == Board::HmiKtp400Mobile;
    }
...
private:
    ...
    void CommitClockRegisters() {
        ...
        if (!BcdToBin(registers_[0], 0x7F, 59, second) ||
            !BcdToBin(registers_[1], 0x7F, 59, minute) ||
            !BcdToBin(registers_[2], 0x3F, 23, hour) ||
            !BcdToBin(registers_[4], 0x3F, 31, day) || day < 1 ||
